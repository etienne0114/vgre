...
enum cudnnBackendAttributeName_t {
    ...
    CUDNN_ATTR_OPERATIONPOOLING_BWD_DXDESC = 74,  // output: data-gradient dx
    CUDNN_ATTR_OPERATIONPOOLING_BWD_DYDESC = 75,  // input:  upstream gradient dy
    CUDNN_ATTR_OPERATIONPOOLING_BWD_IDXDESC = 76,
    CUDNN_ATTR_OPERATIONPOOLING_BWD_PDESC = 77,   // pooling descriptor
    CUDNN_ATTR_OPERATIONPOOLING_BWD_XDESC = 78,   // input: forward x (needed for max argmax)
    CUDNN_ATTR_OPERATIONPOOLING_BWD_YDESC = 79,   // input: forward output y
