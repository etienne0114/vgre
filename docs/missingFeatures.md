...
| cuDNN | ~44 | `cudnnCreate/Destroy`, descriptors (tensor, filter, conv, pooling, activation), `cudnnSetTensor4dDescriptor/GetTensor4dDescriptor`, `cudnnSetFilter4dDescriptor`, `cudnnSetConvolution2dDescriptor/GetConvolution2dForwardOutputDim/FindConvolutionForwardAlgorithm/GetConvolutionForwardAlgorithm_v7/GetConvolutionForwardWorkspaceSize`, `cudnnSetPooling2dDescriptor/GetPooling2dDescriptor/GetPooling2dForwardOutputDim`, `cudnnSetActivationDescriptor`, `cudnnActivationForward/Backward`, `cudnnConvolutionForward/BackwardData/BackwardFilter`, `cudnnPoolingForward/Backward`, `cudnnSoftmaxForward/Backward`, `cudnnBatchNormalizationForwardInference/ForwardTraining/Backward`, `cudnnGetVersion/GetStream/SetStream` |
...
| cuDNN | ~30% | 44 functions implemented; 120+ missing. Forward: conv, activation, pooling, softmax, BN inference/training. Backward: activation, conv backward-data/backward-filter, BN backward, softmax backward, pooling backward. Missing: dropout, RNN/LSTM/GRU, attention, CTC loss, `OpTensor`, `ReduceTensor`, `TransformTensor`. |
