...
| cuDNN | ~27% | 41 functions implemented; 120+ missing. Forward: conv, activation, pooling, softmax, BN inference/training. Backward: activation, conv backward-data/backward-filter. Missing: BN backward, dropout, RNN/LSTM/GRU, attention, CTC loss, `OpTensor`, `ReduceTensor`, `TransformTensor`. |
