...
|---|---|---|
| CUDA Runtime API | ~47% | 100 functions implemented; ~114+ missing including `cudaFuncGetAttributes`, texture/surface objects, graph kernel nodes, stream capture introspection. Error introspection, symbol copies, and array allocation now complete. |
