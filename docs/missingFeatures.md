...
| cuBLAS | ~51 | `cublasCreate/Destroy` (v2), `cublasGet/SetStream/SetMathMode/GetMathMode/GetVersion`, `cublasSgemm/Dgemm/Hgemm/Sgemv` (v2), `cublasSaxpy/Daxpy/Sdot/Ddot/Snrm2/Dnrm2/Sscal/Dscal` (v2), `cublasScopy/Dcopy/Sswap/Dswap/Sasum/Dasum/Isamax/Idamax/Isamin/Idamin/Srot/Drot/Srotg/Drotg/Srotm/Drotm/Srotmg/Drotmg` (v2), `cublasSetPointerMode/GetPointerMode/SetAtomicsMode/GetAtomicsMode`, `cublasStrsv/Dtrsv/Sger/Dger/Ssymv/Dsymv/Sgbmv/Dgbmv/Ssyr/Dsyr/Ssyr2/Dsyr2/Strmv/Dtrmv` (v2), `cublasDgemmBatched/StridedBatched`, `cublasSgemmBatched/StridedBatched`, `cublasGemmEx/GemmBatchedEx/GemmStridedBatchedEx` |
...
| cuBLAS | ~21% | 51 functions implemented; ~190+ missing. Level-1 and Level-2 complete (`Trsv`, `Ger`, `Symv`, `Gbmv`, `Syr`, `Syr2`, `Trmv`). Pointer/atomics mode APIs present. Missing: all Level-3 except `Gemm`, `Trsm`, `Syrk`, `Syr2k`, `Trmm`, `Symm`, `cublasLoggerConfigure`. |
...
2. **High priority**: Add missing cuBLAS Level-3 functions (`Trsm`, `Syrk`, `Syr2k`, `Trmm`, `Symm`) and cuDNN backward passes. Level-1 and Level-2 are now complete.
