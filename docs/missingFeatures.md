...
| cuBLAS | ~39 | `cublasCreate/Destroy` (v2), `cublasGet/SetStream/SetMathMode/GetMathMode/GetVersion`, `cublasSgemm/Dgemm/Hgemm/Sgemv` (v2), `cublasSaxpy/Daxpy/Sdot/Ddot/Snrm2/Dnrm2/Sscal/Dscal` (v2), `cublasScopy/Dcopy/Sswap/Dswap/Sasum/Dasum/Isamax/Idamax/Isamin/Idamin/Srot/Drot/Srotg/Drotg/Srotm/Drotm/Srotmg/Drotmg` (v2), `cublasSetPointerMode/GetPointerMode/SetAtomicsMode/GetAtomicsMode`, `cublasDgemmBatched/StridedBatched`, `cublasSgemmBatched/StridedBatched`, `cublasGemmEx/GemmBatchedEx/GemmStridedBatchedEx` |
...
| cuBLAS | ~16% | 39 functions implemented; ~190+ missing. Level-1 complete (`copy`, `swap`, `scal`, `asum`, `amax`, `amin`, `rot`, `rotg`, `rotm`, `rotmg`). Pointer/atomics mode APIs present. Missing: all Level-2 except `Gemv`, all Level-3 except `Gemm`, triangular solve (`Trsm`/`Trsv`), symmetric (`Syrk`/`Syr2k`), batched `Trsm`, `cublasLoggerConfigure`. |
