...
- **cuDNN** (~29% coverage, ~43/~150+ functions): Forward: conv, pooling, activation (ReLU, sigmoid, tanh, ELU, GELU, SELU, Mish), softmax, BN inference/training. Backward: activation, conv backward-data/backward-filter, BN backward, softmax backward. **Missing**: dropout, RNN/LSTM/GRU, attention, `OpTensor`, `ReduceTensor`.
...
- **cuDNN**: ~29% coverage. Forward complete (including BN training). Backward: activation, conv backward-data/backward-filter, BN backward, softmax backward. Missing: dropout, RNN/LSTM/GRU, attention, `OpTensor`, `ReduceTensor`.
...
- **cuDNN**: dropout, RNN/LSTM/GRU, attention, `OpTensor`, `ReduceTensor`. Activation backward, conv backward-data/backward-filter, BN forward/backward, and softmax backward now complete.
