...
- **cuDNN** (~30% coverage, ~44/~150+ functions): Forward: conv, pooling, activation (ReLU, sigmoid, tanh, ELU, GELU, SELU, Mish), softmax, BN inference/training. Backward: activation, conv backward-data/backward-filter, BN backward, softmax backward, pooling backward. **Missing**: dropout, RNN/LSTM/GRU, attention, `OpTensor`, `ReduceTensor`.
...
- **cuDNN**: ~30% coverage. Forward complete (including BN training). Backward: activation, conv backward-data/backward-filter, BN backward, softmax backward, pooling backward. Missing: dropout, RNN/LSTM/GRU, attention, `OpTensor`, `ReduceTensor`.
...
- **cuDNN**: dropout, RNN/LSTM/GRU, attention, `OpTensor`, `ReduceTensor`. All core backward passes now complete: activation, conv backward-data/backward-filter, BN forward/backward, softmax backward, pooling backward.
