...
### Library Shims
- **cuBLAS** (~15% coverage, ~37/~200+ functions): `cublasSgemm`, `cublasDgemm`, `cublasSaxpy`, `cublasSdot`, `cublasSgemv`, `cublasScopy/Dcopy/Sswap/Dswap/Sasum/Dasum/Isamax/Idamax/Isamin/Idamin/Srot/Drot/Srotg/Drotg/Srotm/Drotm/Srotmg/Drotmg`, batched GEMM, `cublasGemmEx`. **Missing**: all Level-2 except `Gemv`, all Level-3 except `Gemm`, `Trsm`, `Trsv`, `Syrk`, `Ger`, pointer-mode APIs.
...
- **cuBLAS**: ~15% coverage. Level-1 complete (`copy`, `swap`, `scal`, `asum`, `amax`, `amin`, `rot`, `rotg`, `rotm`, `rotmg`). Missing all Level-2 except `Gemv`, all Level-3 except `Gemm`, `Trsm`, `Trsv`, `Syrk`, `Ger`, pointer modes.
...
- **cuBLAS**: `Trsm`, `Trsv`, `Syrk`, `Ger`, all pointer-mode APIs, most Level-2/Level-3. Level-1 now complete.
