...
- **cuDNN** (~33% coverage, ~50/~150+ functions): Forward: conv, pooling, activation (ReLU, sigmoid, tanh, ELU, GELU, SELU, Mish), softmax, BN inference/training, dropout. Backward: activation, conv backward-data/backward-filter, BN backward, softmax backward, pooling backward, dropout. **Missing**: RNN/LSTM/GRU, attention, `OpTensor`, `ReduceTensor`.
...
- **cuDNN**: ~33% coverage. Forward complete (including BN training, dropout). Backward: activation, conv backward-data/backward-filter, BN backward, softmax backward, pooling backward, dropout. Missing: RNN/LSTM/GRU, attention, `OpTensor`, `ReduceTensor`.
...
- **cuDNN**: RNN/LSTM/GRU, attention, `OpTensor`, `ReduceTensor`. All core forward/backward passes now complete: activation, conv, BN, softmax, pooling, dropout.
