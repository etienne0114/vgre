...
### 2. 🚀 [Documentation site](https://etienne0114.github.io/vgre/) — the operator's guide
*   **Purpose**: The complete operator's manual for VGRE deployment and troubleshooting, published as a browsable site (source under [`site/`](site/), generated by [`site/build_site.py`](site/build_site.py) and deployed to GitHub Pages).
*   **Key Contents**:
