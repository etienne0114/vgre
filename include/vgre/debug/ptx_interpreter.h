...
private:
    ...
    // Warp barrier (__syncwarp / bar.warp.sync): release all lanes of the warp once
    // every active lane has arrived (a 32-lane-scoped version of bar.sync).
    void releaseWarpSyncIfReady(int anyTid);
